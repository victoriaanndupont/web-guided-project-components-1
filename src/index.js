...
const makeImage = ({imageURL}) => {
  ...
  const newImg = document.createAttribute.element('div')
...
const accordion = document.querySelector('div.accordian')
...
panelButton.appensChild(closeButton)
...
closeButton.classList.add('panel-btn-close','hise-btn')
